  ...
  return (
    <Form onSubmit={action} className="form-row align-items-end">
      <Form.Group className="mx-2 col-6">
        ...
        <Form.Control name="name" id="name" type="name" defaultValue={contact && contact.name} />
      </Form.Group>
      <Form.Group className="mx-2 col-3">
        <Form.Label htmlFor="phone">Phone:</Form.Label>
        <Form.Control name="phone" id="phone" type="phone" defaultValue={contact && contact.phone}/>
      </Form.Group>
